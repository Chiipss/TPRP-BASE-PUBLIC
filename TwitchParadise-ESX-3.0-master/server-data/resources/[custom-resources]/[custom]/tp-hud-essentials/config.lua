...
cfg = {
	...
	damageFactorEngine = 17.0,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorBody = 17.0,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	...
	limpModeMultiplier = 0.32,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
