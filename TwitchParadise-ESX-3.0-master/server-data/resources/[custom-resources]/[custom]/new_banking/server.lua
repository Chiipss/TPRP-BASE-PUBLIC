...
RegisterServerEvent('tp_bank:deposit')
AddEventHandler('tp_bank:deposit', function(amount)
...
RegisterServerEvent('tp_bank:withdraw')
AddEventHandler('tp_bank:withdraw', function(amount)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    local base = 0
