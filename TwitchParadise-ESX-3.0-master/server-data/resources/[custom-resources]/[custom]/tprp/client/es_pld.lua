...
Citizen.CreateThread(function()
	while true do
		...
		if(var2 ~= 0) and IsPedInAnyVehicle(PlayerPedId(), true) then
			drawTxt(0.675, 1.43, 1.0,1.0,0.32, "~b~[~w~" .. tostring(GetStreetNameFromHashKey(var2)) .. "~b~]", 255, 255, 255, 255)
		end

		if(GetStreetNameFromHashKey(var1) and GetNameOfZone(pos.x, pos.y, pos.z))then
			if(zones[GetNameOfZone(pos.x, pos.y, pos.z)] and tostring(GetStreetNameFromHashKey(var1))) and IsPedInAnyVehicle(PlayerPedId(), true) then
				drawTxt(0.675, 1.45, 1.0,1.0,0.32, direction .. "~b~ | ~w~" .. tostring(GetStreetNameFromHashKey(var1)) .. " ~w~/ " .. zones[GetNameOfZone(pos.x, pos.y, pos.z)], 255, 255, 255, 255)
			end
		end
--[[
		local t = 0
