local Keys = {
  ...
  AddEventHandler('jsfour-licenseplate', function()
    ...
    ESX.UI.Menu.Open(
      ...
      align    = 'bottom-right',
          elements = {
              {label = 'Change Plate', value = 'change'},
      ...
      function(data, menu)
        ...
        if plate ~= nil then
          ...
          local patt = "[^%w]"
          if string.match(plate, patt) then
              -- Stop code
              ESX.ShowNotification("Plate contains illegal characters")
              return
          end
              ...
              if distance ~= -1 and distance <= 3.0 then
                  ...
                  ESX.TriggerServerCallback('jsfour-licenseplate:update', function( cb )
                      ...
                      Citizen.Wait(1000) -- Wait for a second before adding keys
