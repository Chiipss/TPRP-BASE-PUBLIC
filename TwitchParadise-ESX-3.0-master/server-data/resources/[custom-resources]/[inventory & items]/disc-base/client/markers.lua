        ...
        if CurrentMarker and CurrentMarker.shouldDraw() then
            ...
            if IsControlJustReleased(0, 38) then
                if CurrentMarker.action ~= nil then
                    if (CurrentMarker.check) then
                        TriggerServerEvent('disc-base:checkLicence')
                    else  
...
RegisterNetEvent('disc-base:openWeaponShop')
AddEventHandler('disc-base:openWeaponShop', function()
    CurrentMarker.action(CurrentMarker)
end)
