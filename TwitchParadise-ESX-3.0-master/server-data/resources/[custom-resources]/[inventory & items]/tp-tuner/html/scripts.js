$(document).ready(function(){
  ...
  $(".btntuneSystem").click(function(){
    console.log("h345elloooo")
      $.post('http://tp-tuner/tuneSystem', JSON.stringify({ boost: $("#boost").val(),fuel: $("#fuel").val(),gears: $("#gears").val(),braking: $("#braking").val(),drive: $("#drive").val()  }));
  });
  ...
  document.onkeyup = function (data) {
    if ( data.which == 27 ) {
      $.post('http://tp-tuner/close', JSON.stringify({}));
    }
  };
});
