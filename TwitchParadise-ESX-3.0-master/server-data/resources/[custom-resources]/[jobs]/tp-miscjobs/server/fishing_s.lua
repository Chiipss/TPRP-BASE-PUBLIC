...
ESX.RegisterUsableItem('turtlebait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the turtle bait onto your fishing rod', length = 5000})
		--TriggerClientEvent('fishing:message', _source, "~g~You attach the turtle bait onto your fishing rod")
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'You dont have a fishing rod', length = 5000})
...
ESX.RegisterUsableItem('fishbait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the fish bait onto your fishing rod', length = 5000})
...
ESX.RegisterUsableItem('turtle', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the turtle meat onto the fishing rod', length = 5000})
		...
		if rnd >= 78 then
			if rnd >= 94 then
				...
				if xPlayer.getInventoryItem('turtle').count > 4 then
					TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'You cant hold more turtles', length = 5000})
			...
			if rnd >= 75 then
				if xPlayer.getInventoryItem('fish').count > 100 then
					TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'You cant hold more fish', length = 5000})
			...
			if rnd >= 82 then
						...
						if rnd >= 91 then
							...
							if xPlayer.getInventoryItem('shark').count > 0  then
									TriggerClientEvent('fishing:setbait', _source, "none")
									TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'You cant hold more sharks', length = 5000})
