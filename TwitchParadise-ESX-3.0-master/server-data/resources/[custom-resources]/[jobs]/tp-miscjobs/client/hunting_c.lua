...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('You slaughtered the animal and recieved' ..AnimalWeight.. 'kg of meat')

	TriggerServerEvent('tph:reward', AnimalWeight)

	DeleteEntity(AnimalId)
end

function SellItems()
	TriggerServerEvent('tph:sell')
end
