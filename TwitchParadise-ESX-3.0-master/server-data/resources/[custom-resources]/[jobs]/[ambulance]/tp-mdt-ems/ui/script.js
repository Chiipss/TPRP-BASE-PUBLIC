    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://tp-mdt-ems/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://tp-mdt-ems/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://tp-mdt-ems/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://tp-mdt-ems/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://tp-mdt-ems/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://tp-mdt-ems/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://tp-mdt-ems/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://tp-mdt-ems/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://tp-mdt-ems/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://tp-mdt-ems/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://tp-mdt-ems/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://tp-mdt-ems/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://tp-mdt-ems/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://tp-mdt-ems/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://tp-mdt-ems/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://tp-mdt-ems/sentencePlayer', JSON.stringify({
