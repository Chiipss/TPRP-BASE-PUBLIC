local bossUI = {x=16.744123458862,y=-1605.4655761719,z=29.374942779541}
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  if(PlayerData.job.grade_name == "boss" and PlayerData.job.name == "vagos") then
  	createSocietyMenu(bossUI.x,bossUI.y,bossUI.z,"vagostacos", "vagostacos")
  end
...
AddEventHandler('esx:setJob', function(job)
  ...
  if(PlayerData.job.grade_name == "boss" and PlayerData.job.name == "vagos") then
  	createSocietyMenu(bossUI.x,bossUI.y,bossUI.z,"society_vtacos", "Vagos Tacos")
  end
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            if(distance<2.5) then
                DrawM('[E] Open Vagos Tacos Menu', 27, x, y, z - 0.945, 255, 255, 255, 1.5, 15)
...
function renderMenu(name, menuName)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vagostacos',
		{
			title    = menuName,
			align    = 'bottom-right',
			elements = elements
