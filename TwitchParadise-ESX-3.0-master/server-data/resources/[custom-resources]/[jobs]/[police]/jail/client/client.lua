...
RegisterNetEvent("tp-qalle-jail:jailPlayer")
AddEventHandler("tp-qalle-jail:jailPlayer", function(newJailTime)
	jailTime = newJailTime
						...
						function(data3, menu3)
						  	...
						  	if reason == nil then
								...
								if closestPlayer == -1 or closestDistance > 3.0 then
								  	...
								  	TriggerServerEvent("tp-qalle-jail:jailPlayer", GetPlayerServerId(closestPlayer), jailTime, reason)
								end
