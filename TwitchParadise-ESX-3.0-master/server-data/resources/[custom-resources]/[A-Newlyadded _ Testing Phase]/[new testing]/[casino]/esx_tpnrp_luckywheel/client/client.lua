...
local _wheelPos = vector3(977.25, 49.78, 24.68)


local _baseWheelPos = vector3(976.25, 50.78, 22.68)
local Keys = {
...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        Citizen.CreateThread(function()
            ...
            _wheel = CreateObject(model, 978.0117, 50.3487, 23.9561, false, false, true)
...
Citizen.CreateThread(function()
	while true do
        ...
        if(GetDistanceBetweenCoords(coords, _wheelPos.x, _wheelPos.y, _wheelPos.z, true) < 1.5) and not _isRolling then
            ESX.ShowHelpNotification("Press E to test your luck with the $100,000 Wheel")
