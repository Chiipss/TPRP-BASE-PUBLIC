...
$('.create-button').click(function () {
    ...
    $.post("http://character-menu/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function () {
	...
	if (chosenCharacterId > 0) {
		$.post("http://character-menu/DeleteCharacter", JSON.stringify({
			charid: chosenCharacterId,
		}));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://character-menu/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
