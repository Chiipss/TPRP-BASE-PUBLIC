...
AddEventHandler('esx_methcar:smoke', function(posx, posy, posz, bool)
	...
	if bool == 'a' then
		...
		SetPtfxAssetNextCall("core")
		local smoke = StartParticleFxLoopedAtCoord("exp_grd_flare", posx, posy, posz + 1.7, 10.0, 0.0, 0.0, 2.0, false, false, false, false)
...
RegisterNetEvent("tp:policeCall")
AddEventHandler("tp:policeCall", function()
	...
	if math <= 4 then
		print("TRIGGERED")
			if PlayerData.job.name == "police" then
			  exports['mythic_notify']:SendAlert('error', 'Reports of a suspicious vehicle in the area! PLEASE RESPOND IMMEDIATELY', 30000)
			  Citizen.CreateThread(function(...)
				local blipA = AddBlipForRadius(playerCoords.x, playerCoords.y, playerCoords.z, 50.0)
				...
				local blipB = AddBlipForCoord(playerCoords.x, playerCoords.y, playerCoords.z)
				...
				AddTextComponentString      ("Local Report")
					...
					if GetPedInVehicleSeat(car, -1) == playerPed then
						if started == false then
							if displayed == false then
								DisplayHelpText("Press [X] to start making drugs")
								displayed = true
							end
						end
			...
			if progress < 96 then
				...
				if progress > 22 and progress < 24 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Fix using tape')
						ESX.ShowNotification('~o~Press [S] Leave it be ')
						ESX.ShowNotification('~o~Press [D] Replace it')
				...
				if progress > 30 and progress < 32 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Open the windows to get rid of the smell')
						ESX.ShowNotification('~o~Press [S] Leave it be')
						ESX.ShowNotification('~o~Press [D] Put on a mask with airfilter')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 38 and progress < 40 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Raise the pressure')
						ESX.ShowNotification('~o~Press [S] Raise the temperature')
						ESX.ShowNotification('~o~Press [D] Lower the pressure')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 41 and progress < 43 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Do nothing')
						ESX.ShowNotification('~o~Press [S] Try to sucking it out using syringe')
						ESX.ShowNotification('~o~Press [D] Add more lithium to balance it out')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 46 and progress < 49 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Add it in')
						ESX.ShowNotification('~o~Press [S] Put it away')
						ESX.ShowNotification('~o~Press [D] Drink it')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 55 and progress < 58 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Clean it using compressed air')
						ESX.ShowNotification('~o~Press [S] Replace the filter')
						ESX.ShowNotification('~o~Press [D] Clean it using a tooth brush')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 82 and progress < 84 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Try to hold it')
						ESX.ShowNotification('~o~Press [S] Go outside and take a shit')
						ESX.ShowNotification('~o~Press [D] Shit inside')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
				...
				if progress > 88 and progress < 90 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~Press [A] Yes!')
						ESX.ShowNotification('~o~Press [S] No')
						ESX.ShowNotification('~o~Press [D] What if I add meth to glass instead?')
						ESX.ShowNotification('~c~Press the number of the option you want to do')
					end
					if selection == 1 then
						print("Slected 1")
