...
AutoPilotKeyName = "~INPUT_DROP_WEAPON~"		-- [F10] Default, The "Display Name" for the AutoPilot Key  (Others here: https://docs.fivem.net/game-references/controls/)
AutoPilotKeyNumber = 56							-- [F10] Default, The "Key Number" for the AutoPilot Key	(Others here: https://docs.fivem.net/game-references/controls/)
