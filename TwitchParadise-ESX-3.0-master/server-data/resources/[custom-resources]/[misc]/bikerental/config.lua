...
Config.Zones = {
    BikeRental = {
        ...
        ZoneSize = {x = 1.5, y = 1.5, z = 1.5}, -- Zone Size (How large the ring is)
        ...
        Items = { -- Item, label, and price used for the menu
            ...
            {item = 'TRIBIKE', label = 'Triathlon Cycle 1', price = 30},
            {item = 'TRIBIKE2', label = 'Triathlon Cycle 2', price = 35},
            {item = 'TRIBIKE3', label = 'Triathlon Cycle 3', price = 25},
        },
        Pos = { -- Zone positions
