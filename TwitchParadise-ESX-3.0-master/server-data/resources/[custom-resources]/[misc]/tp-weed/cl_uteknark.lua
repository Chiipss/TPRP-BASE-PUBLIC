...
RegisterNetEvent('smokeweed:onPot')
AddEventHandler('smokeweed:onPot', function()
	...
	Citizen.Wait(1000)
    exports['tp-stress']:RemoveStress('instant', 80000)
    exports['mythic_notify']:SendAlert('success', 'You relieved some stress', 7000)
