...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('tprp-doorlock:getDoorInfo', function(doorInfo, count)
...
RegisterNetEvent('tprp-doorlock:currentlyhacking')
AddEventHandler('tprp-doorlock:currentlyhacking', function(mycb)
			mycb = true
		...
		for i=1, #Config.DoorList do
			...
			if distance < maxDistance then
				...
				if  IsControlJustReleased(1,  38) and isAuthorized then
					...
					TriggerServerEvent('tprp-doorlock:updateState', i, doorID.locked)
				end
...
RegisterNetEvent('tprp-doorlock:setState')
AddEventHandler('tprp-doorlock:setState', function(doorID, state)
