...
AddEventHandler('esx_SodaMachine:Random', function(prop_name)
	...
	if lottery <= 6 then
		if not IsAnimated then
			...
			Citizen.CreateThread(function()
				...
				exports['mythic_notify']:DoHudText('inform', 'Soda is coming...')
				...
				Citizen.Wait(700)
				exports['mythic_notify']:DoHudText('inform', 'You just bought a bottle of soda for $1!')
	...
	if lottery == 7 then
			Citizen.CreateThread(function()
			exports['mythic_notify']:DoHudText('inform', 'This machine is temporarily down.')
			end)
		end
	if lottery == 8 then
			Citizen.CreateThread(function()
			exports['mythic_notify']:DoHudText('inform', 'This machine is out of this product.')
			end)
		end
	if lottery == 9 then
			Citizen.CreateThread(function()
			...
			TriggerEvent('InteractSound_CL:PlayOnOne', 'SodaMachine', 1.0)
			Citizen.Wait(5000)
			exports['mythic_notify']:DoHudText('inform', 'The machine swallowed your money and didnt give your soda!')
			FreezeEntityPosition(ped, false)
			end)
		end
end)