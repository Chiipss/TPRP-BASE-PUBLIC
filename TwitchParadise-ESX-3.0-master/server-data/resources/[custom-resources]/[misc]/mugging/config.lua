...
Config.RobWaitTime = 10              --  Current seconds it takes to finish mugging
Config.AddItemsPerctent = 15       --  This is percent the script will add items as well as cash from mugging.
