		...
		if canAfford then
			...
			if Config.FixCarDamage then
				...
				if Config.RealisticVehicleFailure then
			        ...
			        SetVehicleEngineHealth(vehicle, ESX.Math.GroupDigits(Config.SetEngineHealthOnRepair)) 
			        SetVehiclePetrolTankHealth(vehicle, ESX.Math.GroupDigits(Config.SetVehiclePetrolTankHealthOnRepair))
			    else
