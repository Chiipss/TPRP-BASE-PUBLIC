...
ESX.RegisterServerCallback('JAM_VehicleShop:GetShopData', function(source, cb)
	...
	for k,v in pairs(categories) do
		if v.name ~= "importcars" and v.name ~= "importbikes" and v.name ~= "bennyscars" and v.name ~= "bennysbikes" and v.name ~= "cheap" then
...
AddEventHandler('JAM_VehicleShop:CompletePurchase', function(vehicleProps)
	...
	local message = "You just bought a " .. car .." with the plate " ..vehicleProps.plate ..". You should store this car in a garage immediately."
