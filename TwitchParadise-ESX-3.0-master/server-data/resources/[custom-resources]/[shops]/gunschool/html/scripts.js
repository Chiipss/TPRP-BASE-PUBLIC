...
var goodAnswer = [];
var questionUsed = [];
var nbQuestionToAnswer = 7; // don't forget to change the progress bar max value in html
var nbAnswerNeeded = 5; // out of nbQuestionToAnswer
var nbPossibleQuestions = 7; // number of questions in database questions.js
var lastClick = 0;
...
$(".btnQuestion").click(function () {
	$.post('http://gunschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://gunschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://gunschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
