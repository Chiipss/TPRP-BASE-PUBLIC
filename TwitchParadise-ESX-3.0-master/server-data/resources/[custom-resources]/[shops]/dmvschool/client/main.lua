...
function StartTheoryTest()
	...
	TriggerServerEvent('tp_dmvschool:pay', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('tp_dmvschool:addLicense', 'dmv')
...
function StartDriveTest(type)
	...
	TriggerServerEvent('tp_dmvschool:pay', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('tp_dmvschool:addLicense', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
	else
		ESX.ShowNotification(_U('failed_test'))
	end
