...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and PlayerData.job.name == 'mechanic') or (PlayerData.job and PlayerData.job.name == 'cardealer') or not Config.IsMechanicJobOnly then
				for k,v in pairs(Config.Zones) do
