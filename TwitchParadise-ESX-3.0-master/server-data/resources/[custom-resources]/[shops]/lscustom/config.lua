...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 937.422, y = -962.184, z = 39.324},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls2 = {
		Pos   = { x = 938.568, y = -977.242, z = 39.325},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 1766.020, y = 3331.063, z = 40.750},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = 964.740, y = -108.00, z = 74.363},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {0.92, 1.74, 4.71, 5.87}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.65, 3.3, 5.6, 7.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {3.85, 5.23, 7.65}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {0.76, 1.24, 2.24, 3.24, 3.85}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {1.65, 5.28, 7.66, 13.24, 16.12, 19.21}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
