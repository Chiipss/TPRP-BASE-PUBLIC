...
RegisterServerEvent('tp:restarting')
AddEventHandler('tp:restarting', function()
    TriggerClientEvent('vSync:updateWeather', -1, RestartWeather, true)
    Citizen.Wait(7000)
    TriggerClientEvent('vSync:updateTime', -1, 0, 0, true)
end)
...
function NextWeatherStage()
    ...
    elseif CurrentWeather == "CLEARING" or CurrentWeather == "OVERCAST" then
        ...
        elseif new == 2 or new == 3 then
            CurrentWeather = "CLOUDS"
        elseif new == 4 or new == 5 then
            CurrentWeather = "CLEAR"
        elseif new == 6 or new == 7 then
            CurrentWeather = "EXTRASUNNY"
        elseif new == 8 or new == 9 then
            CurrentWeather = "SMOG"
        else
            CurrentWeather = "FOGGY"
        end
